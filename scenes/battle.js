...
export function makeBattle(p) {
  return {
    ...
    npcPokemon: makePokemon(
      ...
      100,
      [
        { name: "PSYSTRIKE", power: 60 },
        { name: "SHADOW BALL", power: 45 },
        { name: "AURA SPHERE", power: 50 },
        { name: "PSYCHIC", power: 55 },
      ],
    ...
    playerPokemon: makePokemon(
      ...
      [
        ...
        { name: "THUNDERBOLT", power: 55 },
        { name: "QUICK ATTACK", power: 40 },
        { name: "IRON TAIL", power: 50 },
      ],
    ...
    load() {
      ...
      this.npcPokemon.spriteRef = p.loadImage("assets/MEWTWO.png");
      this.playerPokemon.spriteRef = p.loadImage("assets/PIKACHU.png");
